// 大家首先可以随便找一个 Vue 项目，看下其中 VueRouter 的使用，大概分为以下：
...
// 创建 Vue 根实例时传入 router 实例，会往所有 Vue 实例上添加 $route 和 $router 属性。
// 我们不会在 Vue 中的代码里实现添加 $router 的代码，所以可以在 install 方法里就将这部分代码写上，然后等待创建 Vue 根实例的时候再执行。
